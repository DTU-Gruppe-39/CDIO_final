...
public class ChanceDeck {
	...
	public void CreateCards(){
		...
		Cards[8] = new RecieveCard("Chance8", 3000);
		Cards[9] = new PayCard("Chance8", -200);
		Cards[10] = new PayCard("Chance9", -200);
		Cards[11] = new PayCard("Chance10", -1000);	
		Cards[12] = new PayCard("Chance11", -1000);
		Cards[13] = new PayCard("Chance12", -2000);
		Cards[14] = new PayCard("Chance13", -3000);
		Cards[15] = new PayCard("Chance14", -3000);
		Cards[18] = new JailCard("Chance17");
		Cards[19] = new JailCard("Chance18");
		Cards[20] = new MoveCard("Chance19", 30);
		Cards[21] = new MoveCard("Chance20", 30);
		Cards[25] = new MoveCard("Chance24", 0);
	}
